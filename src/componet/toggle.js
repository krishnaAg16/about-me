const Switch = ({ isChecked, setIsChecked }) => {
    ...
    return (
        <label className='themeSwitcherThree md:bottom-5 md:right-5 fixed bottom-2 right-2 inline-flex cursor-pointer select-none items-center'>
            <input
                type='checkbox'
                checked={isChecked}
            ...
            <div className='shadow-card flex items-center justify-center rounded-md'>
                <span
                    className={`flex h-9 w-9 items-center justify-center rounded ${isChecked ? 'bg-primary text-yellow-500 bg-white' : 'hidden'
                        }`}
                >
                    <svg
                        width='16'
                ...
                <span
                    className={`flex h-9 w-9 items-center justify-center rounded ${!isChecked ? 'bg-primary text-gray-400 bg-gray-800' : 'hidden'
                        }`}
                >
                    <svg
                        width='16'
